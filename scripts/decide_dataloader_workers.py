#!/usr/bin/env python3
"""Apply the predeclared 15% full-concurrency DataLoader worker gate."""
...
from oge.studies.preflight import decide_num_workers, load_infrastructure_config
...
def main() -> int:
    ...
    measurements = [
        json.loads(path.read_text(encoding="utf-8")) for path in args.measurement
    ]
    decision = decide_num_workers(measurements, infrastructure)
