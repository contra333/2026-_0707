...
- the WRN-28-10 optimizer-HPO protocol v1.1, reviewed frozen 64-row discovery
  tables, and deterministic study/trial/attempt orchestration;
...
- production discovery HPO, confirmation, and final multi-seed execution;
