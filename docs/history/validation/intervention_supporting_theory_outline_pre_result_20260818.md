# Pre-result intervention/supporting-theory outline (historical)

This is the preserved pre-consolidation outline. It contains prospective gates,
including the now-closed RtMD path, and is retained for provenance only. Current
paper logic lives in `docs/paper/intervention_supporting_theory_outline.md` and
`docs/paper/task_f_result_analysis.md`.
