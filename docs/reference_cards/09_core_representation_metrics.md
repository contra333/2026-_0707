...
a raw/L2-off kNN variant is forbidden within v1.2. Later protocols may define
separate raw controls without altering this historical key, formula, or output. Evidence:
...
Current focal and control roles live only in
[`13_active_paper_protocol.md`](13_active_paper_protocol.md). They do not
relabel historical v1.2 outputs. Full DDU/SN training remains unimplemented
and unvalidated.
