...
paper lineup; current experiment order lives only in
[`13_active_paper_protocol.md`](13_active_paper_protocol.md).
...
that ground. The active paper protocol owns the current gap statement: from-scratch paired
