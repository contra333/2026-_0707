...
def _trial(index):
    record = {
        ...
        "trial_id": f"grid-sgd-{index:02d}",
        "study_id": "study",
        "phase": "grid",
        "optimizer_family": "sgd",
        "assigned_slot": index,
        "lr_rank": 0,
        "weight_decay_rank": index,
        "scientific_config": {
...
def test_versioned_schema_validators_reject_wrong_versions_and_require_identity():
    ...
    study = {
        ...
        "study_id": "study",
        "host_id": "curie",
        "preflight_freeze_hash": "preflight",
        "host_manifest_hash": "host-manifest",
        "throughput_decision_hash": "throughput",
        "grid_version": "wrn28_10_optimizer_grid_v1.2",
        "grid_hash": "hash",
        "grid_manifest_hash": "manifest",
        "ordered_table_hashes": {},
        "optimizer_families": ["sgd", "adam", "adamw"],
        ...
        "status": "planned",
        "gpu_hours": {},
        "terminal_slot_accounting": {"assigned": 36, "terminal": 0},
    }
